...
<html lang="en" xmlns:th="http://www.w3.org/1999/xhtml">
  ...
  <div class="nav-scroller py-1 mb-2">
    <nav class="nav d-flex justify-content-between">
      ...
      <a class="p-2 text-muted" href="index.php">Menu <img class ="p-2 text-muted" src="img/icono-portafolio.png" height="30px" alt=""></a>
      <a class="p-2 text-muted" href="login.php">Login  <img class ="p-2 text-muted" src="img/icono-portafolio.png" height="30px" alt=""></a>
      <a class="p-2 text-muted" href="logout-page.php">Logout  <img class ="p-2 text-muted" src="img/icono-portafolio.png" height="30px" alt=""></a>
      <a class="p-2 text-muted" href="posts.php">Posts  <img class ="p-2 text-muted" src="img/icono-portafolio.png" height="30px" alt=""></a>
...
<div class="blog-pagination col-md-6" style="margin-top:100px;">
    <input id="post-title" class="form-control" type="text" placeholder="titulo" value="" required/>
    <input id="upload" class="form-control" type="file" accept="image/*" value="Examinar" name="Examinar" required/>
    <textarea id="txt_description" class="form-control" placeholder="leave a comment..." style="height:100px;" required></textarea><br>
