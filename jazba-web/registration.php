            ...
            <form  action="registration" method="post">
                ...
                <div class="col-md-6 mb-3">
                    <div class="form-group">
                        <label>DNI</label>
                        <input class="form-control" type="number" name="dni" placeholder="" >
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="lastNameFather" placeholder="" >
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="lastNameMother" placeholder="" >
                        </div>
                    </div>
                </div>
                <div class="row">
